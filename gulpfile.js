 ...
 */
gulp.task("build-debug", ["publish-thirdparty", "build-css", "build-img", "build-ts-debug", "build-html", "build-mocks", "configure-debug"]);

/**
 * Build all project in output directory
 */
gulp.task("build-release", ["publish-thirdparty", "build-css", "build-img", "build-ts-release", "build-html", "build-mocks", "configure-release"]);
